    ...
    public class DijkstraTiempo
    {
        ...
        private void iniVecDij()
        {
            ...
            foreach (Nodo n in nodos)
            {
                ...
                {
                    infinito += ady.getPonderacionTiempo();
                }
            }
        ...
        private void actualizarPesos(ElementoDijkstra e)
        {
            ...
            foreach (Ady ady in nID.getListaAdyacencia())
            {
                ...
                if (nAdy.getElementoD().getDefinitivo() == false)
                {
                    ...
                    if (ady.getPonderacionTiempo() + pesoDefi < vD[indexAdy].getPeso())
                    {
                        vD[indexAdy].setProveniente(nID, ady.getPonderacionTiempo() + pesoDefi);
                    }
                }
